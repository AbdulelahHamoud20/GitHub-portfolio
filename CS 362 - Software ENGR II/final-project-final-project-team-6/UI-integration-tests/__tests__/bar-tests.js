...
test("Correctly adds values in the bar chart builder", async() => {
    initDomFromFiles(
            __dirname + "/../../src/bar/bar.html",
            __dirname + "/../../src/bar/bar.js"
    );
...
describe("Alert tests for bar chart builder", () => {
    // clear local storage
    beforeEach(() => {
...
test("All fields clear/reset correctly for bar chart builder", async() => {
    initDomFromFiles(
        __dirname + "/../../src/bar/bar.html",
        __dirname + "/../../src/bar/bar.js"
    );
    ...
    await user.type(chartTitle, "My Bar Chart");
    await user.type(axisLabelX, "X-Axis");
    await user.type(axisLabelY, "Y-Axis");
